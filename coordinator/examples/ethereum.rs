...
.sql("SELECT timestamp, transaction_hash::BYTEA, transfer_from::BYTEA, transfer_to::BYTEA, string_from_uint256_bytes(transfer_amount) as transfer_amount_string FROM erc20_transfers WHERE block_number > 21840000 AND block_number < 21841000")
.await
